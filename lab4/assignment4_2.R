#2. Data whose distribution is close to lognormal are common. Size measurements of bio-
#logical organisms often have this character. As an example, consider the measurements of
